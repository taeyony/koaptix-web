...
const SGG_UNIVERSE_REGISTRY: UniverseRegistryItem[] = [
  ...
  // Batch 10 - 2026-04-22 staged exposure from confirmed SGG candidates
  {
    code: "SGG_41150",
    label: "의정부시",
    scope: "SIGUNGU",
  ...
  // Batch 11 - 2026-04-22 staged exposure from confirmed SGG candidates
  {
    code: "SGG_44133",
    label: "천안시 서북구",
    scope: "SIGUNGU",
  ...
  // Batch 12 - 2026-04-22 staged exposure from confirmed SGG candidates
  {
    code: "SGG_27230",
    label: "북구",
    scope: "SIGUNGU",
  ...
  // Batch 13 - 2026-04-22 staged exposure from confirmed SGG candidates
  {
    code: "SGG_28185",
    label: "연수구",
    scope: "SIGUNGU",
  ...
  // Batch 14 - 2026-04-22 staged exposure from confirmed SGG candidates
  {
    code: "SGG_41173",
    label: "안양시 동안구",
    scope: "SIGUNGU",
  ...
  // Batch 15 - 2026-04-23 staged exposure from confirmed SGG candidates
  {
    code: "SGG_48310",
    label: "거제시",
    scope: "SIGUNGU",
  ...
  // Batch 16 - 2026-04-23 staged exposure from confirmed SGG candidates
  {
    code: "SGG_26290",
    label: "남구",
    scope: "SIGUNGU",
  ...
  // Batch 17 - 2026-04-23 staged exposure from confirmed SGG candidates
  {
    code: "SGG_50110",
    label: "제주시",
    scope: "SIGUNGU",
  ...
  // Batch 18 - 2026-04-23 staged exposure from confirmed SGG candidates
  {
    code: "SGG_26110",
    label: "중구",
    scope: "SIGUNGU",
  ...
  // Batch 19 - 2026-04-23 staged exposure from confirmed SGG candidates
  {
    code: "SGG_26170",
    label: "동구",
    scope: "SIGUNGU",
  ...
  // Batch 20 - 2026-04-23 staged exposure from confirmed SGG candidates
  {
    code: "SGG_26230",
    label: "부산진구",
    scope: "SIGUNGU",
  ...
  // Batch 21 - 2026-04-23 staged exposure from confirmed SGG candidates
  {
    code: "SGG_26320",
    label: "북구",
    scope: "SIGUNGU",
  ...
  // Batch 22 - 2026-04-24 staged exposure from confirmed SGG candidates
  {
    code: "SGG_26440",
    label: "강서구",
    scope: "SIGUNGU",
  ...
  // Batch 23 - 2026-04-24 staged exposure from confirmed SGG candidates
  {
    code: "SGG_26500",
    label: "수영구",
    scope: "SIGUNGU",
  ...
  // Batch 24 - 2026-04-24 staged exposure from confirmed SGG candidates
  {
    code: "SGG_26710",
    label: "기장군",
    scope: "SIGUNGU",
  ...
  // Batch 25 - 2026-04-25 staged exposure from confirmed SGG candidates
  {
    code: "SGG_27140",
    label: "동구",
    scope: "SIGUNGU",
  ...
  // Batch 26 - 2026-04-25 staged exposure from confirmed SGG candidates
  {
    code: "SGG_27200",
    label: "남구",
    scope: "SIGUNGU",
  ...
  // Batch 27 - 2026-04-25 staged exposure from confirmed SGG candidates
  {
    code: "SGG_27720",
    label: "군위군",
    scope: "SIGUNGU",
  ...
  // Batch 28 - 2026-04-25 staged exposure from confirmed SGG candidates
  {
    code: "SGG_28140",
    label: "동구",
    scope: "SIGUNGU",
  ...
  // Batch 29 - 2026-04-25 staged exposure from confirmed SGG candidates
  {
    code: "SGG_28200",
    label: "남동구",
    scope: "SIGUNGU",
  ...
  // Batch 30 - 2026-04-25 staged exposure from confirmed SGG candidates
  {
    code: "SGG_28245",
    label: "계양구",
    scope: "SIGUNGU",
  ...
  // Batch 31 - 2026-04-25 staged exposure from confirmed SGG candidates
  {
    code: "SGG_29110",
    label: "동구",
    scope: "SIGUNGU",
