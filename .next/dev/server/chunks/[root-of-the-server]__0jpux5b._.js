...
"[project]/src/app/api/rankings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$koaptix$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLatestRankBoard"])(limit, offset);
        return Response.json({
            data: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$koaptix$2f$mappers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapLatestRankBoardRows"])(rows)
        }, {
            status: 200
        });
    } catch (error) {
        return Response.json({
            error: "랭킹 데이터를 더 불러오지 못했습니다."
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0jpux5b._.js.map