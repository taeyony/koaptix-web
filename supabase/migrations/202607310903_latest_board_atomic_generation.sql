...
begin
  ...
  if exists (
    ...
    raise exception '903 definition deployment requires zero recovery-role membership';
  end if;
end;
$preconditions$;
...
begin
  ...
  if exists (
    ...
    raise exception '903 created or observed a forbidden recovery-role membership';
  end if;
